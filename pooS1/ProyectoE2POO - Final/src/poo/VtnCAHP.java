 ...
 * @author pcpru
 */
public class VtnCAHP extends javax.swing.JFrame
{
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        ...
        {
            Manipulacion.consultasTabP(VtnPrincipal.d, VtnPrincipal.h, jTable_Alum,this);
        } else
        {
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnCAHP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
