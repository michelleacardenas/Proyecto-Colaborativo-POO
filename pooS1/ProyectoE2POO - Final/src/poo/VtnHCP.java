 ...
 * @author medra
 */
public class VtnHCP extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jButton_Regresar2.setToolTipText("Regresar al Submenú de Personal");
        jButton_Regresar2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jLabel17.setText("CVE del Personal");
        ...
        jLabel2.setText("Ingreso de Consulta de Personal");
    ...
    {//GEN-HEADEREND:event_fechasKeyPressed
        Validaciones.enterCadenaNoVacia(this, evt, cve, fechas);
    }//GEN-LAST:event_fechasKeyPressed

    private void fechaActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_fechaActionPerformed
    {//GEN-HEADEREND:event_fechaActionPerformed
        Validaciones.validaFecha(this, fechas.getText().length(), fechas.getText(), fecha, fechas);
