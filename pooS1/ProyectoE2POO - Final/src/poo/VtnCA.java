...
public class VtnCA extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jTable_Alum.setAlignmentX(1.0F);
        jTable_Alum.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jTable_Alum.setGridColor(new java.awt.Color(51, 51, 0));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 780, 420));
        ...
        jLabel4.setText("Consulta de Alumnos");
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        ...
        {
            Manipulacion.consultasTab(VtnPrincipal.d, 1, jTable_Alum);
        } else
        {
