...
public class VtnRA extends javax.swing.JFrame
{
    ...
    public void filtros()
    {
        if (d != null)
        {
            ...
            {
                Manipulacion.consultasTab(dt, 1, jTable_reg);
            } else
            {
    ...
    private void initComponents()
    {
        ...
        imprimirBTN.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        mostrarRbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        check_Muj.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        check_Ale.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        check_Hom.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(check_Hom, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, -1, 20));

        check_diab.setText("Diabetes");
        check_diab.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        boton_MayFrec.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        boton_MenFrec.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jButton_Regresar.setToolTipText("Regresar al Submenú de Alumnos");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, 790, 370));

        jLabel6.setFont(new java.awt.Font("Zilla Slab SemiBold", 1, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 204));
        jLabel6.setText("de Alumnos");
        ...
        reiniciarbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jButton1.setToolTipText(" https://www.uaemex.mx");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 500, 140, -1));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/blanco.jpg"))); // NOI18N
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 920, 530));
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnRA.class
